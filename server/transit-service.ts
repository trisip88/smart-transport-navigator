...
export const SG_LOCATIONS: Record<string, { lat: number; lng: number; code?: string; name: string; type: 'mrt' | 'bus_stop' | 'landmark' }> = {
  ...
  'Dhoby Ghaut MRT': { lat: 1.2989, lng: 103.8456, code: 'NS24/NE6/CC1', name: 'Dhoby Ghaut MRT Interchange', type: 'mrt' },
  ...
  'Marina Bay Sands': { lat: 1.2838, lng: 103.8591, name: 'Marina Bay Sands', type: 'landmark' },
